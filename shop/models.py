...
class Product(models.Model):
    ...
    category = models.CharField(max_length=20, choices=CATEGORY_CHOICES, default='skins')
    users = models.ManyToManyField('accounts.CustomUser')  # Many-to-many relationship
